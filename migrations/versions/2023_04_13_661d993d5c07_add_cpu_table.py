...
def upgrade():
    ...
    sa.Column('multi_thread_rating', sa.Integer(), nullable=False),
    sa.Column('single_thread_rating', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('name')
    )
    op.execute("""
INSERT INTO cpu(cpu_name,threads,release_date,multi_thread_rating,single_thread_rating) VALUES
